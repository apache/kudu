...
and compiled into HTML and output using the link:https://asciidoctor.org/[Asciidoctor]
...
----
................
| Include only part of a separate file | Similar to Javadoc | See https://asciidoctor.org/docs/user-manual/#by-tagged-regions
...
----
image::https://inkscape.org/doc/examples/tux.svg[Tux,250,350]
----
(or `image:`)
...
* list item 1
----
(see https://asciidoctor.org/docs/user-manual/#unordered-lists)
| Numbered lists | numbered list |
----
. list item 2
----
(see https://asciidoctor.org/docs/user-manual/#ordered-lists)
...
| Sidebars, quotes, or other blocks of text | a block of text, formatted differently from the default | Delimited using different delimiters, see https://asciidoctor.org/docs/user-manual/#built-in-blocks-summary. Some of the examples above use delimiters like \...., ----,====.
........
[example]
====
...
| A table | a table | See https://asciidoctor.org/docs/user-manual/#tables. Generally rows are separated by newlines and columns by pipes

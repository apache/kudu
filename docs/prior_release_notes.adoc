...
link:https://kudu.apache.org/releases/[documentation of the appropriate release]
...
link:https://kudu.apache.org/docs/schema_design.html[schema design documentation]
for more details.
...
- The Kudu C++ client library now has Doxygen-based
  link:https://kudu.apache.org/cpp-client-api/[API documentation]
  available online.

- Kudu now
  link:https://kudu.apache.org/2016/06/17/raft-consensus-single-node.html[
...
- Some default settings related to I/O behavior during flushes and compactions have been changed:
  ...
  link:https://kudu.apache.org/2016/04/26/ycsb.html[Experiments using YCSB] indicate that these
...
previous link and link:https://developers.redhat.com/blog/2015/02/05/gcc5-and-the-c11-abi/.

...
link:https://www.bailis.org/blog/linearizability-versus-serializability[blog post]
...
[bibliography]
== References
- [[[ht,1]]] David Alves, Todd Lipcon and Vijay Garg. Technical Report: HybridTime - Accessible Global Consistency with High Clock Uncertainty. April, 2014. https://users.ece.utexas.edu/~garg/pdslab/david/hybrid-time-tech-report-01.pdf

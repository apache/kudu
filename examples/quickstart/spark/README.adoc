...
dataset at https://kudu-sample-data.s3.amazonaws.com/sfmtaAVLRawData01012013.csv.gz
+
...
[source,bash]
----
wget https://kudu-sample-data.s3.amazonaws.com/sfmtaAVLRawData01012013.csv.gz
...
[source,bash]
----
spark3-shell --packages org.apache.kudu:kudu-spark3_2.12:1.18.1
----
...
that uses the link:https://www.nextbus.com/xmlFeedDocs/NextBusXMLFeed.pdf[SFMTA XML data feed]

...
lazy val root = (project in file("."))
  ...
  .settings(
    ...
    libraryDependencies += "org.apache.kudu" % "kudu-test-utils" % "1.18.0" % "it",
    libraryDependencies += "org.apache.kudu" % "kudu-binary" % "1.18.0" % "it" classifier osDetectorClassifier.value,

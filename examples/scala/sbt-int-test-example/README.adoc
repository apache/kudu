...
lazy val root = (project in file("."))
  ...
  .settings(
    ...
    libraryDependencies += "org.apache.kudu" % "kudu-test-utils" % "1.18.1" % "it", //<2>
    libraryDependencies += "org.apache.kudu" % "kudu-binary" % "1.18.1" % "it" classifier osDetectorClassifier.value, //<3>

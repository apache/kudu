---
title: Apache Kudu release 1.18.1
layout: single_col
active_nav: download
...
## Apache Kudu release 1.18.1

See the [Kudu 1.18.1 Release Notes](docs/release_notes.html).
...
* Verify the checksum by downloading the release and the `.sha512` file, and
  running the following command:
    * On Linux: `sha512sum -c apache-kudu-1.18.1.tar.gz.sha512`
    * On MacOS: `shasum -a 512 -c apache-kudu-1.18.1.tar.gz.sha512`
* Verify the signature by downloading the release and the `.asc` file, and
  doing the following:
    ...
    * Run `gpg --verify apache-kudu-1.18.1.tar.gz.asc apache-kudu-1.18.1.tar.gz`

Additional links:

* [Kudu 1.18.1 Documentation](docs/)
* [Kudu 1.18.1 Java API docs](apidocs/)
* [Kudu 1.18.1 C++ API docs](cpp-client-api/)

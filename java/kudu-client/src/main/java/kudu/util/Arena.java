...
/**
 * <p>
 * The Arena is basically a bump-the-pointer allocator that allocates
 * big byte[] chunks from and then doles it out to threads that request
 * ranges into the array.
 * From the Apache HBase project as the MemStoreLAB class
 *
 * TODO do we need the thread safetyness? Remove?
 */
public class Arena {
  ...
  public Arena(int maxAlloc, int chunkSize) {
    ...
    Preconditions.checkArgument(
        maxAlloc <= chunkSize,
        "chunkSize must be less than maxAlloc");
  }

...
struct VersionField {
 ...
 private:
  enum {
    ...
    BTREE_VINSERT_MASK =
        0b00001111'11111111'11111111'11111111'11111100'00000000'00000000'00000000,
    BTREE_VSPLIT_MASK =
        0b00000000'00000000'00000000'00000000'00000011'11111111'11111111'11111111,
  };
 ...
 private:
  ...
  LeafNode<Traits> *TraverseToLeaf(const Slice &key,
    ...
    while (node.type() != NodePtr<Traits>::LEAF_NODE) {
      ...
      AtomicVersionValue new_node_version = node_base->AcquireVersion2WayBarrier();
  ...
  void PrepareMutation(PreparedMutation<Traits> *mutation) {
    ...
    while (true) {
      ...
      lnode->Lock();
      if (VersionField::HasSplit(lnode->AcquireVersion2WayBarrier(), stable_version)) {

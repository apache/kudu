...
### Does Kudu need to be deployed on separate nodes?

No, Kudu can share hardware with HDFS based Hadoop clusters. All testing of Kudu
has been performed on this type of deployment.
...
No, Kudu does not support multi-row transactions at this time. However, single
row operations are atomic within that row.
